...
| REQ-116 | AI 实时超分（Mac PoC + 实时管线） | MOD-VIDEO-AIUPSCALE | `src/video/ai_upscaler.cpp` + `src/video/ai_upscale_service.cpp` + `tools/ai_upscale_demo.cpp` + `src/main.cpp --ai-upscale` | ✅ PoC + SDL/Metal 异步集成 |
